...
public class TestSelectClause extends TestStatementUtils {
    ...
    public void testForeignKeyTableElementPartial() {
        ...
        assertEquals(true, 
        		containsErrorCode(cvs, QuickFixFactory.DiagnosticErrorId.INCOMPLETE_FOREIGN_KEY.getErrorCode()),
                "Expected error not found: " + Messages.Error.INCOMPLETE_FOREIGN_KEY);
    }
    ...
    public void testInvalidSelect_2() {
        ...
        assertEquals(true, 
        		containsErrorCode(cvs, QuickFixFactory.DiagnosticErrorId.INCOMPLETE_SCHEMA_REF.getErrorCode()),
                "Expected error not found: " + Messages.Error.INCOMPLETE_SCHEMA_REF);
        assertEquals(true, 
        		containsErrorCode(cvs, QuickFixFactory.DiagnosticErrorId.PROJECTED_SYMBOLS_VIEW_COLUMNS_MISMATCH.getErrorCode()),
                "Expected error not found: " + Messages.Error.PROJECTED_SYMBOLS_VIEW_COLUMNS_MISMATCH);
    }
    ...
    public void testInvalidSelect_3() {
        ...
        assertEquals(true, 
        		containsErrorCode(cvs, QuickFixFactory.DiagnosticErrorId.UNEXPECTED_COMMA.getErrorCode()),
                "Expected error not found: " + Messages.Error.UNEXPECTED_COMMA);
    }
    ...
    public void testInvalidSelect_4() {
        ...
        assertEquals(true, 
                ...
                "Expected error not found: " + Messages.Error.PROJECTED_SYMBOLS_VIEW_COLUMNS_MISMATCH);
        assertEquals(true, 
        		containsErrorCode(cvs, QuickFixFactory.DiagnosticErrorId.INVALID_COLUMN_MISSING_COMMA.getErrorCode()),
                "Expected error not found: " + Messages.Error.INVALID_COLUMN_MISSING_COMMA);
    }
    ...
    public void testInvalidSelect_6() {
        ...
        assertEquals(1, cvs.getExceptions().size());
        assertEquals(true, 
        		containsErrorCode(cvs, QuickFixFactory.DiagnosticErrorId.MISSING_FROM_KEYWORD.getErrorCode()),
        		"Expected error not found: " + Messages.Error.MISSING_FROM_KEYWORD);
    }
    ...
    public void testInvalidSelect_8() {
        ...
        assertEquals(false, cvs.getQueryExpression().getSelectClause().isStar());
        assertEquals(1, cvs.getExceptions().size());
        assertEquals(true, containsErrorCode(cvs, 
