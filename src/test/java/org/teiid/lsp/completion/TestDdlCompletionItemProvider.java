...
public class TestDdlCompletionItemProvider {
    ...
    private final static int MAX_ITEMS_389 = 389;
    private final static int MAX_ITEMS = 638;
...
//      0123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789
        ...
        assertEquals(MAX_ITEMS_389, items.size());
...
//       0123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789
        ...
        for( CompletionItem item: items) {
        	System.out.println(item.getLabel() + "  kind = " + item.getKind().name());
        }

        assertEquals(MAX_ITEMS, items.size());
        items = itemProvider.getCompletionItems(stmt, new Position(0, 46));
        assertEquals(MAX_ITEMS, items.size());
    }
...
//               0123456789 123456789 123456789 123456789 123456789 123456789 123456789 123456789
        ...
        List<CompletionItem> items = itemProvider.getCompletionItems(stmt, new Position(0, 44));
        assertEquals(1, items.size());
        // Expecting  NOTHING since user needs to define an alias ID
        items = itemProvider.getCompletionItems(stmt, new Position(0, 47));
        assertEquals(0, items.size());
        // After Table Symbol
        // Expecting  a comma or WHERE clause
        items = itemProvider.getCompletionItems(stmt, new Position(0, 49));
        assertEquals(0, items.size());
        // Expecting WHERE clause
        items = itemProvider.getCompletionItems(stmt, new Position(0, 50));
        assertEquals(1, items.size());
        // Expecting maybe full item list but with a validation error?
        items = itemProvider.getCompletionItems(stmt, new Position(0, 51));
        assertEquals(1, items.size());
