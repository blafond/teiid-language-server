...
import org.teiid.lsp.TeiidTextDocumentService;
import org.teiid.lsp.completion.DdlCompletionConstants;
...
import org.teiid.lsp.parser.statement.CreateViewStatement;
...
public class DdlCompletionProvider extends CompletionItemBuilder {
    ...
    private final TeiidTextDocumentService workspaceService;
//    private final MetadataService metadataService;

    public DdlCompletionProvider(TeiidTextDocumentService workspaceService) {
        super();
        ...
        try {
            ...
            if (previousToken != null) {
                ...
                switch (tokenContext.getContext()) {
                    ...
                    {
                        items.addAll(
                                new QueryExpressionItemProvider().getCompletionItems(tokenContext));
                    }
                    break;
                case NONE_FOUND:
