 ...
 */
package org.teiid.lsp.diagnostics;
...
public final class DdlDiagnostics {
    ...
    public static void publishDiagnostics(TextDocumentItem ddlDocument, TeiidLanguageServer languageServer) {
    ...
    public static void clear(TextDocumentItem ddlDocument, TeiidLanguageServer languageServer) {
